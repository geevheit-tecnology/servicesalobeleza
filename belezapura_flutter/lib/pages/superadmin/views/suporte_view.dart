  ...
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          const Text('Suporte/Tickets', style: TextStyle(fontFamily: 'Fraunces', fontSize: 32, fontWeight: FontWeight.w500)),
          ...
          Container(
            ...
            child: const Text('Módulo de suporte em desenvolvimento...', style: TextStyle(color: AppTheme.mutedForeground)),
          ),
        ],
      ),
    );
