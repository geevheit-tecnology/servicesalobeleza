    ...
    <div className="p-6 space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground text-sm">Outubro 2024</p>
        </div>
        <Badge variant="success" className="text-sm px-3 py-1">✓ Plataforma operacional</Badge>
      </div>

      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        <StatCard label="Salões ativos" value="2.418" sub="+94 este mês" icon={Store} trend={21} color="primary" />
        <StatCard label="MRR" value="R$ 49,2K" sub="Receita recorrente" icon={TrendingUp} trend={9} color="emerald" />
        <StatCard label="Assinaturas ativas" value="2.241" sub="92,7% do base" icon={CreditCard} trend={8} color="purple" />
        <StatCard label="Inadimplentes" value="87" sub="3,6% da base" icon={AlertCircle} trend={-2} color="rose" />
        <StatCard label="Agendamentos/mês" value="182.400" icon={Sparkles} trend={14} color="sky" />
        <StatCard label="Clientes na plataforma" value="94.200" icon={Users} trend={18} color="amber" />
        <StatCard label="Novos salões" value="94" sub="este mês" icon={Plus} trend={15} color="primary" />
        <StatCard label="Tickets abertos" value="12" sub="2 urgentes" icon={HeadphonesIcon} trend={-5} color="rose" />
      </div>
