...
export default function Marketing({ onNavigate }: { onNavigate: (view: string) => void }) {
    ...
    <div className="min-h-full bg-background font-sans">
      ...
      <header className="sticky top-0 z-50 bg-background/90 backdrop-blur-md border-b border-border">
        <div className="max-w-6xl mx-auto px-5 h-16 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-3">
            ...
            <Button size="sm" onClick={() => onNavigate("salon")}>Começar grátis</Button>
          </div>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative max-w-6xl mx-auto px-5 py-28 md:py-40">
          ...
          <div className="flex flex-wrap gap-3">
            <Button size="lg" onClick={() => onNavigate("salon")} className="bg-white text-foreground! hover:bg-white/95 shadow-lg font-semibold">
              Começar agora <ArrowRight className="w-4 h-4" />
            </Button>
            <Button size="lg" variant="outline" onClick={() => onNavigate("client")} className="border-white/40 text-white hover:bg-white/10">
              Ver como cliente
            </Button>
          </div>
      ...
      <section className="py-24">
        <div className="max-w-3xl mx-auto px-5 text-center">
          ...
          <Button size="lg" onClick={() => onNavigate("salon")}>
